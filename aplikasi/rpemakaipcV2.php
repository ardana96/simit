			...
			$namabulan=$dataa['bulan'];}
				?>
                                ...
                                <tr class="gradeC">		
									...
									<td class="center">
										<form action="user.php?menu=fupdate_pemakaipcV2" method="post" >
											<input type="hidden" name="nomor" value=<?php echo $nomor; ?> />
											<button  name="tombol" class="btn text-muted text-center btn-primary" type="submit">Perawatan</button>
										</form> 
									</td>
									<td class="center">
										<form action="user.php?menu=fupdate_kerusakanpcV2" method="post" >
									...
									<td class="center">
										<form action="aplikasi/deletepemakaipcV2.php" method="post" >
											<input type="hidden" name="nomor" value=<?php echo $nomor; ?> />
